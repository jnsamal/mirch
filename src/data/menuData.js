...
export const MENU = {
  Starters: [
    { name: "Kanika Corn Chaat", desc: "Sweet corn, tamarind, roasted peanut", price: 170, spice: 1, veg: true, kind: "bowl", image: beetrootTikkiPlate },
    { name: "Tandoori Prawns", desc: "Clay-oven prawns, byadgi chili marinade", price: 340, spice: 2, veg: false, kind: "skewer", image: beetrootTikkiPlate },
    ...
    { name: "Chili Garlic Mushroom", desc: "Wok-tossed button mushroom, dry red chili", price: 220, spice: 2, veg: true, kind: "bowl", image: loadedSweetPotatoFries },
    { name: "Lamb Seekh Kebab", desc: "Hand-minced lamb, charcoal grilled", price: 360, spice: 2, veg: false, kind: "skewer", image: loadedSweetPotatoFries },
    { name: "Crispy Okra Fry", desc: "Thin-cut bhindi, chickpea flour, chaat masala", price: 180, spice: 1, veg: true, kind: "bowl", image: sabudanaKhichdiBowl },
  ...
  Mains: [
    ...
    { name: "Paneer Lababdar", desc: "Cashew-tomato gravy, cream, kasuri methi", price: 360, spice: 1, veg: true, kind: "bowl", image: fusionBurgerFries },
    { name: "Odia Prawn Curry", desc: "Mustard-poppy seed paste, raw mango", price: 460, spice: 3, veg: false, kind: "bowl", image: thaliSpread },
    { name: "Palak Kofta", desc: "Spinach dumplings, light onion-tomato gravy", price: 300, spice: 1, veg: true, image: palakKoftaBowl },
    { name: "Mutton Rogan Josh", desc: "Kashmiri chili, yogurt, slow-braised", price: 480, spice: 2, veg: false, kind: "bowl", image: thaliSpread },
  ...
  "Rice & Bread": [
    { name: "Lemon Rasam Rice", desc: "Tangy tempered rice, curry leaf, mustard", price: 190, spice: 1, veg: true, kind: "rice", image: bread },
    { name: "Mutton Biryani", desc: "Sealed and rested, saffron, fried onion", price: 420, spice: 2, veg: false, kind: "rice", image: bread },
    { name: "Ghee Rice", desc: "Whole spice, caramelised onion", price: 180, spice: 0, veg: true, kind: "rice", image: bread },
    { name: "Laccha Paratha", desc: "Layered clay-oven flatbread", price: 70, spice: 0, veg: true, kind: "bread", image: bread },
    { name: "Garlic Naan", desc: "Roasted garlic, coriander, butter finish", price: 80, spice: 0, veg: true, kind: "bread", image: bread },
  ],
  "Drinks & Sweets": [
