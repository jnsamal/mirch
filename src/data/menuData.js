...
export const MENU = {
  Starters: [
    { name: "Kanika Corn Chaat", desc: "Sweet corn, tamarind, roasted peanut", price: 170, veg: true, kind: "bowl", image: beetrootTikkiPlate900, imageMobile: beetrootTikkiPlate480  },
    ...
    { name: "Chili Garlic Mushroom", desc: "Wok-tossed button mushroom, dry red chili", price: 220, veg: true, kind: "bowl", image: beetrootTikkiPlate900, imageMobile: beetrootTikkiPlate480 },
  ...
  Mains: [
    { name: "Chicken Chettinad", desc: "Roasted spice blend, curry leaf, coconut", price: 440, veg: false, kind: "bowl", image: palakKoftaBowl900, imageMobile: palakKoftaBowl480 },
    { name: "Paneer Lababdar", desc: "Cashew-tomato gravy, cream, kasuri methi", price: 360, veg: true, kind: "bowl", image: palakKoftaBowl900, imageMobile: palakKoftaBowl480 },
    ...
    { name: "Mutton Rogan Josh", desc: "Kashmiri chili, yogurt, slow-braised", price: 480, veg: false, kind: "bowl", image: palakKoftaBowl900, imageMobile: palakKoftaBowl480 },
  ...
  "Rice & Bread": [
    { name: "Lemon Rasam Rice", desc: "Tangy tempered rice, curry leaf, mustard", price: 190, veg: true, kind: "rice", image: thaliSpread900, imageMobile: thaliSpread480 },
    { name: "Mutton Biryani", desc: "Sealed and rested, saffron, fried onion", price: 420, veg: false, kind: "rice", image: thaliSpread900, imageMobile: thaliSpread480 },
    { name: "Ghee Rice", desc: "Whole spice, caramelised onion", price: 180, veg: true, kind: "rice", image: thaliSpread900, imageMobile: thaliSpread480 },
    { name: "Laccha Paratha", desc: "Layered clay-oven flatbread", price: 70, veg: true, kind: "bread", image: thaliSpread900, imageMobile: thaliSpread480 },
    { name: "Garlic Naan", desc: "Roasted garlic, coriander, butter finish", price: 80, veg: true, kind: "bread", image: thaliSpread900, imageMobile: thaliSpread480 },
  ],
  "Drinks & Sweets": [
